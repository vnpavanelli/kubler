...
PACKAGES=""
EMERGE_BIN="emerge"
CROSSDEV_TARGET="armv7a-hardfloat-linux-gnueabi"
...
auto-sync = no" > /etc/portage/repos.conf/crossdev.conf
    ...
    ln -s /usr/portage/profiles/arch/arm/armv7a /usr/${CROSSDEV_TARGET}/etc/portage/make.profile
    ...
    sed -i '7i CHOST=armv7a-hardfloat-linux-gnueabi \
CC=${CHOST}-gcc \
